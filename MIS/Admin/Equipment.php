                ...
                <button class="btn btn-primary" onclick="window.print()">Print</button>
                    <thead class="header fixed-top">
                        <tr>
                            ...
                            <th id="th3" scope="col">Professor Name</th>
                            <th id="th3" scope="col">Srudent Name</th>
                            <th id="th3" scope="col">Student Number</th>
                            ...
                            <th class="th" scope="col">Requested Items</th>
                            <th class="th" scope="col">Purpose</th>
