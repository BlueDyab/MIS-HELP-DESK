...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        integrity="sha384-YQp1wFdsy1Z3dCU5ym8nfcfJWIPSK1rYBprYO8r00ELIOknvRr4aRKeqWSS6I6Zh" crossorigin="anonymous">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="Service.php" id="service" class="sidebar-link"><i
                                    class="fa-solid fa-user"></i>Service</a>
                        </li>

                        <li class="sidebar-item">
                            <a href="Feedback.php" id="feedback" class="sidebar-link"><i
                                    class="fa-solid fa-comments"></i>Feedback</a>
                        </li>

                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
                                data-bs-target="#equipmentDropdown" aria-expanded="false"
                                aria-controls="equipmentDropdown">
                                <i class="fa-solid fa-wrench"></i>
                                <span>Equipment</span>
                            </a>
                            <ul id="equipmentDropdown" class="sidebar-dropdown list-unstyled collapse">
                                <li class="sidebar-item">
                                    <a href="ProfessorEquipment.php" id="equipment" class="sidebar-link"><i
                                            class="fa-solid fa-chalkboard-user"></i>Professor</a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="StudentEquipment.php" id="room" class="sidebar-link"><i
                                            class="fa-solid fa-user"></i>Student</a>
                                </li>
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
                                data-bs-target="#roomDropdown" aria-expanded="false" aria-controls="roomDropdown">
                                <i class="fa-solid fa-desktop"></i>
                                <span>Room</span>
                            </a>
                            <ul id="roomDropdown" class="sidebar-dropdown list-unstyled collapse">
                                <li class="sidebar-item">
                                    <a href="ProfessorRoom.php" id="room" class="sidebar-link"><i
                                            class="fa-solid fa-chalkboard-user"></i>Professor</a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="StudentRoom.php" id="room" class="sidebar-link"><i
                                            class="fa-solid fa-user"></i>Student</a>
                                </li>
...
try {
    ...
    if ($client_count) {
        ...
        foreach ($client_count as $acc) {
            ...
            if ($status == 0) {
                // Status is pending
                echo "<td><span style='background-color: yellow; color: black; padding: 4px 8px; border-radius: 4px;'>Pending</span></td>";
            } elseif ($status == 1) {
                // Status is replied
                echo "<td><span style='background-color: blue; color: white; padding: 4px 8px; border-radius: 4px;'>Replied</span></td>";
            } elseif ($status == "Done") {
                // Status is Done
                echo "<td><span style='background-color: green; color: white; padding: 4px 8px; border-radius: 4px;'>Done</span></td>";
            } else {
                // Handle other status values if needed
                echo "<td>" . htmlspecialchars($status) . "</td>";
            }
            echo "<td class='td'>" .
                "<button class='btn btn-success m-2 reply' data-id='" . htmlspecialchars($acc['ID']) . "' name='AcceptDenied'><i class='bi bi-check-square-fill'></i> Reply</button>" .
                // "<button class='btn btn-danger denied' data-id='" . htmlspecialchars($acc['ID']) . "'><i class='bi bi-x-square-fill'></i> Done</button>" .
                "</td>";
            echo "</tr>";
    ...
    $('#replyForm').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                swal("Success!", response, "success").then((value) => {
                    // Reload the page
                    location.reload();
                });
            },
            error: function(xhr, status, error) {
                ...
                swal("Error!", "Failed to submit form: " + xhr.responseText, "error");
            }
        });
    });
